...
def sprint5_dag():
    ...
    with TaskGroup(group_id='lessons') as tg_lessons:
        with TaskGroup(group_id='stg_load') as tg_stg_load:
        ...
        with TaskGroup(group_id='dds_load') as tg_dds_load:
        ...
        with TaskGroup(group_id='dds2_load') as tg_dds2_load:
        ...
        # [ddsusers_dict, ddsrestaurants_dict, ddstimestamps_dict]
        # [ddsproducts_dict, ddsorders_dict]
        tg_stg_load >> tg_dds_load >> tg_dds2_load >> ddsproductsales_dict >> cdm_settlement_report_dict  # type: ignore

    with TaskGroup(group_id='project') as tg_project:
        with TaskGroup(group_id='stg_load') as tg_stg_load:
        ...
        tg_stg_load >> tg_dds_load >> courier_ledgers_dict

    tg_lessons >> tg_project
